...
// ===================================================================================================
esp_err_t Mhz19UartImpl :: readCo2 (int &co2, int &temperature, uart_port_t uartNum, gpio_num_t txPin, gpio_num_t rxPin)
{
    ...
    ESP_RETURN_ON_FALSE (len == sizeof(response), ESP_FAIL, tag, "Wrong response received: expected %d bytes, got %d bytes", sizeof(response), len);
